...
class CreditCardsControllerTest < ActionController::TestCase
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post :create, credit_card: { balance: @credit_card.balance, due_date: @credit_card.due_date, name: @credit_card.name }
    end
  ...
  test "should update credit_card" do
    patch :update, id: @credit_card, credit_card: { balance: @credit_card.balance, due_date: @credit_card.due_date, name: @credit_card.name }
    assert_redirected_to credit_card_path(assigns(:credit_card))
  end
